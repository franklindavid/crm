...
{!! Form::open(['route'=>'costumerservicemanager.clients.index','method'=>'GET','class'=>'navbar-form pull-right']) !!}
	...
	<tbody>	
		@foreach($clients as $client)          
            ...
            <tr>
            	...
            	<td>{{ $client->tipo }}</td>            	
            	<td><a title="ver detalles" href="{{ route('costumerservicemanager.clients.show',$client->id) }}" class="btn btn-success btn-xs">
            	    <i class="fa fa-eye"></i> 
            	</a>
               <a title="ver tickets" href="{{ route('costumerservicemanager.clients.ticket',$client->id) }}" class="btn btn-warning btn-xs">
