...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-briefcase"></i> Negociaciones <font style="text-transform: capitalize;">{{$user->name}}</font></h2>   
    </div>
