...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-archive"></i> <i class="fa fa-wrench"></i>  Productos y servicios </h2>   
    </div>
...
<div role="tabpanel">
    ...
    <div class="tab-content">
       {!! Form::open(['route'=>'salesmanager.products.showProductSalesManager','method'=>'GET','class'=>'navbar-form pull-right']) !!}
    ...
    {!! Form::close() !!}
        <div role="tabpanel" class="tab-pane active" id="Seccion1">	
           <a title="genera pdf" href="product/pdf?name={{$request}}" class="btn btn-danger">Generar pdf <i class="fa fa-file-pdf-o"></i></a> <br>
