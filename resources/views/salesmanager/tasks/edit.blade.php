...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-pencil"></i>Editar tarea  <font style="text-transform: capitalize;">{{$task->client->estado}} {{$task->client->name}}</font></h1> 
    </div>
        <div class="panel-body">
{!! Form::open(array('route' => ['salesmanager.tasks.update',$task->id], 'method' => 'put')) !!}
<!--{!! Form::open(['route'=>'salesmanager.tasks.store','method'=>'POST']) !!}-->
