...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-calendar"></i> Agenda </h2>   
    </div>
...
-->
              ...
              <!-- /input-group -->
              {!! Form::open(['route'=>'salesmanager.events.create','method'=>'POST','id' =>'form-calendario']) !!}
              {!! Form::close() !!}
            </div>
          </div>
        </div>
	  ...
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	            ...
	            <!-- form start -->
<!--	            {!! Form::open(['route'=>'salesmanager.events.update2','method'=>'POST']) !!}-->
	            {!! Form::open(array('route' => ['salesmanager.schedule.update2',null], 'method' => 'put')) !!}﻿
