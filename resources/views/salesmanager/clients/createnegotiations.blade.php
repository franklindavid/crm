@extends('layouts.app')
@section('title','registrar negociación')
@section('content')
<body style="background-color:#E0F2F0">
<div class="panel panel-default">     
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-briefcase"></i> Registrar negociación <font style="text-transform: capitalize;">{{$client->estado}} {{$client->name}}</font> </h2>   
    </div>
        <div class="panel-body">
{!! Form::open(['route'=>'salesmanager.negotiation.storenegotiation','id'=>'formulario','method'=>'POST']) !!}
