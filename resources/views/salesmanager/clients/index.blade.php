...
{!! Form::open(['route'=>'salesmanager.clients.index','method'=>'GET','class'=>'navbar-form pull-right']) !!}
		...
		@foreach($clients as $client)          
            ...
            <tr>
            	...
            	<td>
                  ...
                  @endif
                    <a title="modificar" href="{{ route('salesmanager.clients.edit',$client->id) }}" class="btn btn-warning btn-xs">
