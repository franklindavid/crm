...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-usd"></i> Ventas <font style="text-transform: capitalize;">{{$client->estado}} {{$client->name}}</font></h2>   
    </div>
        <div class="panel-body">
        
<a href="{{ route('salesmanager.clients.createsales',$client->id) }}" class="btn btn-info">Crear Venta</a><br>
	...
	<tbody>	
		@foreach($negotiations as $negotiation)             
            <tr>            	
                ...
                <td>
                    <a title="ver detalle" href="{{ route('salesmanager.sales.show',$negotiation->id) }}" class="btn btn-success btn-xs">
                       <i class="fa fa-eye"></i>
                    </a>             
                </td>         	
            </tr>            
