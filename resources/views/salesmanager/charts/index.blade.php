...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-bar-chart"></i> Estadisticas <font style="text-transform: capitalize;">{{ Auth::user()->name }}</font> </h2>   
    </div>
...
<nav class="navbar navbar-default"> 
  <div class="container-fluid">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="#" onclick="seis()">numero de Negociaciones diario</a></li>
            <li><a href="#" onclick="siete()">numero de Ventas diario</a></li>
        </ul>
    </li>
    </ul>
  </div>
