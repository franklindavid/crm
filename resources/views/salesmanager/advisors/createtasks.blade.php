...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-pencil"></i> Asignar tarea <font style="text-transform: capitalize;"> {{$advisor->name}}</font> </h2>   
    </div>
        <div class="panel-body">
<br>
{!! Form::open(['route'=>'salesmanager.tasks.store','method'=>'POST']) !!}
 
 {!! Form::text('user_id',$advisor->id,['class'=>'form-control hidden','required']) !!} 
