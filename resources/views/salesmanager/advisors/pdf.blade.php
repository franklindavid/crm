                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <span class="label label-primary">serv cliente</span>
                         ...
                         <td><center><span class="badge bg-red">{{ $user->clients()->where('estado', '=', 'prospecto')->count() }}</span></center></td>
                      <td><center><span class="badge bg-blue">{{ $user->clients()->where('estado', '=', 'cliente')->count() }}</span></center></td>
                      <td><center><span class="badge bg-red">{{ $user->negotiations()->where('estado', '!=', 'ganada')->count() }}</span></center></td>
                      <td><center><span class="badge bg-blue">{{ $user->negotiations()->where('estado', '=', 'ganada')->count() }}</span></center></td>
                         @endif
