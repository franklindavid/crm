...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-calendar"></i> Agenda <font style="text-transform: capitalize;">{{$advisor->name}}</font></h2>   
    </div>
...
-->
              ...
              <!-- /input-group -->
              {!! Form::open(['route'=>'admin.events.create','method'=>'POST','id' =>'form-calendario']) !!}
              {!! Form::close() !!}
            </div>
          </div>
        </div>
	  ...
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	            ...
	            <!-- form start -->
<!--	            {!! Form::open(['route'=>'admin.events.update2','method'=>'POST']) !!}-->
	            {!! Form::open(array('route' => ['admin.schedule.update2',null], 'method' => 'put')) !!}﻿
...
@section('js')
  ...
  //while(reload==false){
    $('#calendar').fullCalendar({
      ...
      events: { url:"../../cargaScheduleusuario/{{$id}}"},
...
//        console.log(event.lugar);
      ...
      dayClick: function(date, jsEvent, view) {
        ...
        eventClick: function (event, jsEvent, view) {
            console.log('deja de clickearme hdp');
