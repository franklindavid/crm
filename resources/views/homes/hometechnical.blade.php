...
<!--	            {!! Form::open(['route'=>'advisor.events.update2','method'=>'POST']) !!}-->
	            {!! Form::open(array('route' => ['technical.schedule.update2',null], 'method' => 'put')) !!}﻿
...
@section('js')
  ...
  //while(reload==false){
    $('#calendar').fullCalendar({
      ...
      events: { url:"technical/cargaSchedule"},
      ...
      drop: function (date, allDay) { // this function is called when something is dropped
        ...
        eventResize: function(event) {
          ...
          crsfToken = document.getElementsByName("_token")[0].value;
            $.ajax({
              url: 'technical/actualizaSchedule',
