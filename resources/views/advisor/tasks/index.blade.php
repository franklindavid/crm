...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-pencil"></i> Tareas </h2>   
    </div>
        <div class="panel-body"> 
<div class="">
    <a href="{{ route('advisor.tasks.create') }}" class="btn btn-info">Agregar tarea</a>
</div> 
<br>
