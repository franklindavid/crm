...
-->
              ...
              <!-- /input-group -->
              {!! Form::open(['route'=>'advisor.events.create','method'=>'POST','id' =>'form-calendario']) !!}
              {!! Form::close() !!}
            </div>
          </div>
        </div>
	  ...
	  <div class="modal-dialog modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	            ...
	            <!-- form start -->
<!--	            {!! Form::open(['route'=>'advisor.events.update2','method'=>'POST']) !!}-->
	            {!! Form::open(array('route' => ['advisor.schedule.update2',null], 'method' => 'put')) !!}﻿
