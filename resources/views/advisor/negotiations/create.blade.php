@extends('layouts.app')
@section('title','Abrir negociacion')
@section('content')
<body style="background-color:#E0F2F0">
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-briefcase"></i> Abrir negociación </h2>   
    </div>
        <div class="panel-body">
        
{!! Form::open(['route'=>'advisor.negotiations.store','id'=>'formulario','method'=>'POST']) !!} 
...
<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
    <div class="form-group">
        ...
        {!! Form::select('estado',['en proceso'=>'EN PROCESO','ganada'=>'GANADA','perdida'=>'PERDIDA'],null,['class'=>'form-control select-estado','placeholder'=>'seleccione una opcion...','required']) !!}
    </div>
</div>
<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <div class="input-group-btn">
                <button title="agregar producto" class="glyphicon glyphicon-plus btn btn-primary btn-sm" type="button" id="bt_add_product"></button> 
            </div>
        </div>
