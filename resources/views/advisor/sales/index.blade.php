...
<a href="{{ route('advisor.sales.create') }}" class="btn btn-info">Registrar</a>
...
{!! Form::open(['route'=>'advisor.sales.index','method'=>'GET','class'=>'navbar-form pull-right']) !!}
		...
		@foreach($negotiations as $negotiation)  
           @if($negotiation->estado == "ganada")            
            <tr>
                ...
                <td>
                   <a title="ver detalles" href="{{ route('advisor.sales.show',$negotiation->id) }}" class="btn btn-success btn-xs">
                      <i class="fa fa-eye"></i>   
                   </a>                                       
                </td>         	
            </tr> 
