...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-usd"></i> Registrar venta </h2>   
    </div>
        <div class="panel-body">
{!! Form::open(['route'=>'advisor.sales.store','id'=>'formulario','method'=>'POST']) !!}
