...
<a href="{{ route('advisor.clients.createsales',$client->id) }}" class="btn btn-info">Crear Venta</a><br>
<h3>{{$client->name}}</h3>
	...
	<tbody>	
		@foreach($negotiations as $negotiation)             
            <tr>            	
                ...
                <td>
                   <a title="ver detalle" href="{{ route('advisor.sales.show',$negotiation->id) }}" class="btn btn-success btn-xs">
                    <i class="fa fa-eye"></i>
                   </a>                
                </td>         	
            </tr>            
