...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-user"></i> Registrar cliente/prospecto </h2>    
    </div>
        <div class="panel-body">
{!! Form::open(['route'=>'advisor.clients.store','method'=>'POST']) !!}
