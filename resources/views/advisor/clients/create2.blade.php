@extends('layouts.app')
@section('title','agregar referido')
@section('content')
<body style="background-color:#E0F2F0">
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-user"></i> Registrar referido </h2>   
    </div>
        <div class="panel-body">
{!! Form::open(['route'=>'advisor.referreds.store2','method'=>'POST']) !!}
...
<!--
 ...
 <div class="form-group">
 	...
 	{!! Form::select('estado',['prospecto'=>'prospecto','cliente'=>'cliente'],null,['class'=>'form-control','placeholder'=>'seleccione una opcion...','required']) !!}
 </div>
-->
 <div class="form-group">
