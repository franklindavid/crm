...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-pencil"></i> Tareas <font style="text-transform: capitalize;">{{$client->estado}} {{$client->name}}</font> </h1>   
    </div>
        <div class="panel-body">
        

<div class="">
    <a href="{{ route('advisor.clients.createtasks',$client->id) }}" class="btn btn-info">Asignar tarea</a>
</div> 
<div role="tabpanel">
                ...
                <tbody>	  
                    @foreach($taskstoday as $task)          
                        ...
                        <tr>
                            ...
                            <td>
                               <a title="modificar" href="{{ route('advisor.tasks.edit',$task->id) }}" class="btn btn-warning btn-xs">
                                   <i class="fa fa-wrench"></i>
                               </a>
                                <a  title="eliminar" href="{{ route('advisor.tasks.destroy',$task->id) }}" onclick="return confirm('¿desea eliminar la terea')" class="btn btn-danger btn-xs">
