...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-pencil"></i> Tareas Asesor <font style="text-transform: capitalize;"> {{$advisor->name}}</font></h1>   
    </div>
        <div class="panel-body">
<div class="">
    <a href="{{ route('admin.users.createtasks',$advisor->id) }}" class="btn btn-info">Agregar tarea</a>
</div>  
                ...
                <tbody>	  
                    @foreach($taskstoday as $task)          
                        ...
                        <tr>
                            ...
                            <td>
                               <a title="modificar" href="{{ route('admin.tasks.edit',$task->id) }}" class="glyphicon glyphicon-wrench btn btn-warning btn-xs"></a>
                                <a  title="eliminar" href="{{ route('admin.tasks.destroy',$task->id) }}" onclick="return confirm('¿desea eliminar la terea')" class="glyphicon glyphicon-remove btn btn-danger btn-xs"></a>
                            </td>
                        </tr>
