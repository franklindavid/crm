...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h2><i class="fa fa-pencil"></i> Asignar tarea </h2>   
    </div>
        <div class="panel-body">
{!! Form::open(['route'=>'admin.tasks.store','method'=>'POST']) !!}
 
 {!! Form::text('user_id',$id,['class'=>'form-control hidden','required']) !!} 
