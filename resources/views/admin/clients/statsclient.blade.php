@extends('layouts.app')
@section('title','Estadisticas Cliente')
@section('left')
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="#" onclick="tickets()">Tickets</a></li>
    </ul>
  </div>
</nav>
    <div class="col-md-6">
      ...
      <select class="form-control hidden" id="anio_sel_ticket"  onchange="cambiar_fecha_ticket();">
        <option value="2017" >2017</option>
        <option value="2018">2018</option>
        <option value="2019" >2019</option>
        <option value="2020" >2020</option>
...
<script> 
    ...
    function cambiar_fecha_ticket(){
        var anio_sel=$("#anio_sel_ticket").val();
        cargar_tickets_anuales(anio_sel,{{$id}});
    }
    function ventas(){
    ...
    function tickets(){
        $('#anio_sel_venta').addClass('hidden');
        $('#anio_sel_referido').addClass('hidden');
        $('#anio_sel_ticket').removeClass('hidden');
        var anio_sel=$("#anio_sel_ticket").val();
        cargar_tickets_anuales(anio_sel,{{$id}});
    }
...
//        console.log(url);
    ...
    options.title.text='negociaciones/ventas {{ $client->name}} '+anio;
...
//        console.log(totalventas);
    ...
    function cargar_tickets_anuales(anio,id){
    var options={
         chart: {
                renderTo: 'container',
                type: 'column'
...
//    $("#div_grafica_barras").html( $("#cargador_empresa").html() );
    ...
    var url = "../../grafica_tickets_anuales_cliente/"+anio+"/"+id+"";
//        console.log(url);
...
//        console.log(totalventas);
    var i=0;
     ...
     //options.title.text="aqui e podria cambiar el titulo dinamicamente";
    options.title.text='Tickets {{ $client->name}} '+anio;
     chart = new Highcharts.Chart(options);
