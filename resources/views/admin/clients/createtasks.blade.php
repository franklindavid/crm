@extends('layouts.app')
@section('title','agregar tarea '.$client->name)
@section('content')
<body style="background-color:#E0F2F0">
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-pencil"></i> Asignar tarea <font style="text-transform: capitalize;">{{$client->name}}</font></h1>   
    </div>
