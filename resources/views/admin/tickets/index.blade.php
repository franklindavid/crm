...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-tags"></i> Tickets </h1> 
    </div>
...
<a href="{{ route('admin.tickets.create') }}" class="btn btn-info">Abrir ticket</a><br>
</div>
<div role="tabpanel">
...
<!--                        <td>{{ $ticketpendiente->estado }}</td>-->
                        ...
                        @else
                           <td> 
                               <a href="{{ route('admin.clients.show',$ticketpendiente->client->id) }}">
                        ...
                        <td>
                           <center>
                            <a title="modificar" href="{{ route('admin.tickets.edit',$ticketpendiente->id) }}" class="btn btn-warning btn-xs">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <a title="resuelto" href="{{ route('admin.tickets.resuelto',$ticketpendiente->id) }}" class="btn btn-primary btn-xs">
                                <i class="fa fa-check"></i>
                            </a>
                            <a title="descartar" href="{{ route('admin.tickets.descartar',$ticketpendiente->id) }}" onclick="return confirm('¿desea descartar el ticket?')" class="btn btn-danger btn-xs">
		...
		@foreach($ticketsresueltos as $ticketresuelto)
            <tr>
                ...
                @if($ticketresuelto->client_id==null)
                    <td>Desconocido</td>
                @else
                    <td><a href="{{ route('admin.clients.show',$ticketresuelto->client->id) }}">
            	...
            	<td>
                   <center>
                        <a title="modificar" href="{{ route('admin.tickets.edit',$ticketresuelto->id) }}" class="btn btn-warning btn-xs">
                            <i class="fa fa-wrench"></i>
                        </a>
                        <a title="retornar a pendiente" href="{{ route('admin.tickets.pendiente',$ticketresuelto->id) }}" class="btn btn-success btn-xs">
                            <i class="fa fa-refresh"></i>    
                        </a>
                        <a title="descartar" href="{{ route('admin.tickets.descartar',$ticketresuelto->id) }}" onclick="return confirm('¿desea descartar el ticket?')" class="btn btn-danger btn-xs">
                            <i class="fa fa-times"></i>    
                        </a>
                   </center>
                </td>
...
<!--            	<td>{{ $ticketdescartado->nombre }}</td>-->
                ...
                @if($ticketdescartado->client_id==null)
                    <td>Desconocido</td>
                @else
                    <td><a href="{{ route('admin.clients.show',$ticketdescartado->client->id) }}">
            	...
            	<td>
                   <center>
                    <a title="eliminar permanentemente" href="{{ route('admin.tickets.destroy',$ticketdescartado->id) }}" onclick="return confirm('¿desea eliminar de manera permanente el ticket?')" class="btn btn-danger btn-xs">
