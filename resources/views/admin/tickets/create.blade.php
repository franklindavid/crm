...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-tags"></i> Abrir ticket </h1> 
    </div>
...
<!-- 	{!! Form::text('caso',null,['class'=>'form-control','placeholder'=>'Caso','required']) !!}-->
 	{!! Form::select('caso',['Soporte Tecnico'=>'Soporte tecnico','Garantia'=>'Garantia','Quejas'=>'Quejas','Reclamos'=>'Reclamos','Mantenimiento'=>'Mantenimiento','Devoluciones'=>'Devoluciones','Otros'=>'Otros'],null,['class'=>'form-control','placeholder'=>'seleccione una opcion...','required']) !!}
 </div>
 <div class="form-group">
...
-->
    ...
    <div class="form-group">
        ...
        {!! Form::select('user_id',$technicals,null,['class'=>'form-control select-user','required']) !!}
    </div>
<!--
 <div class="form-group">
...
<!--
 <div class="form-group">
        ...
        {!! Form::select('estado',['pendiente'=>'PENDIENTE','descartado'=>'DESCARTADO'],null,['class'=>'form-control','placeholder'=>'seleccione una opcion...','required']) !!}
 </div> 
-->
