...
<div class="panel panel-default">    
    <div class="panel-heading" style="background-color:#8BCEE5; color:white"><h1><i class="fa fa-tags"></i> Editar ticket </h1> 
    </div>
        <div class="panel-body">
{{-- {!! Form::open(['route'=>'admin.users.update','method'=>'PUT']) !!} --}}
{!! Form::open(array('route' => ['admin.tickets.update',$ticket->id], 'method' => 'put')) !!}﻿
 ...
 <div class="form-group">
    ...
    {!! Form::select('estado',['pendiente'=>'PENDIENTE','resuelto'=>'RESUELTO','descartado'=>'DESCARTADO'],$ticket->estado,['class'=>'form-control','placeholder'=>'seleccione una opcion...','required']) !!}
 </div>
<div class="form-group">
...
<div class="form-group">
    ...
    {!! Form::select('client_id',$clients,$ticket->client_id,['class'=>'form-control select-client','placeholder' => 'Desconocido']) !!}
</div>
<div class="form-group">
    {!! Form::label('user_id','Tecnico') !!}
    {!! Form::select('user_id',$technicals,$ticket->user_id,['class'=>'form-control select-user','placeholder' => 'Desconocido']) !!}
</div>
<div class="form-group">
